...
def weighting(gold_frame, pred_frame, gold_args, pred_args):  # non-core는 span만 찾으면 정답이라고 쳐줌.
...
def evaluate_FrameType(gold_data, parsed_data):
    tic()
...
def evaluate_args(gold_data, parsed_data):
    tic()
    ...
    for i in range(len(parsed_data)):
        ...
        weighted_gold_frame, weighted_pred_frame, weighted_gold_arg, weighted_pred_arg = weighting(gold_frame,
                                                                                                   pred_frame, gold_arg,
                                                                                                   pred_arg)
